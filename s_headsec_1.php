...
if(isset($_POST['save']))
  ...
  $l=$_POST['event_3'];
      ...
      if($_SESSION['Event']=="security")
        {         
                  
                  
                  
for($i=0;$i<$x;$i++){
      $s="UPDATE security SET `event_associated_1`='".$k[$i]."' , event_associated_2='".$j[$i]."',event_associated_3='".$l[$i]."' WHERE roll_no='".$ro[$i]."'";
...
require("/Applications/XAMPP/xamppfiles/htdocs/FMS/PHPMailer/src/Exception.php");
  ...
  $mail = new PHPMailer;
      ...
      $mail->Subject = " Your schedule for security ";

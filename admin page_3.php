...
if(isset($_POST['delete'])){
	$r=$_POST['roll_no'];
	$sql15="SELECT * from hosting where roll_no='$r'";
	...
	if($resultCheck2>0){
	$sql14=" DELETE from hosting where roll_no='$r'";
...
$sql2 = "INSERT INTO hosting (full_name,roll_no,gender,stream,email,mob_no,day_1,day_2,day_3) VALUES ('$name','$roll_no','$gender','$stream','$email ','$mob_no','$day1','$day2','$day3')";
